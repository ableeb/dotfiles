" ~/.vim/sessions/appenginehello.vim: Vim session script.
" Created by ~/.vim/autoload/session.vim on 07 February 2012 at 10:02:33.
...
exe 'vert 2resize ' . ((&columns * 196 + 114) / 228)
argglobal
enew
file NERD_tree_1
setlocal fdm=indent
...
1wincmd w
bwipeout
NERDTree ~/projects/appengine/helloworld
1resize 67|vert 1resize 31|2resize 67|vert 2resize 196|
tabnext 1
2wincmd w
